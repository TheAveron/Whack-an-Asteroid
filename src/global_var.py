...
Texts_menu: list[Text] = [
    Text("Play", (0, 40), color=(42, 40, 57)),
...
Texts_game: dict[str, Text | Sprite] = {
    ...
    "Lose": Text("Perdu"),
    "Pause": Sprite(
        "Pause", type="Pause", position=(game_data["width"] - 66, 20), indexage=False
    ),
}
"""Textes de la partie"""
Texts_end: list[Text | dict[str, Text]] = [
    Text("Restart", (0, 110), 60, color=(42, 40, 57)),
    {
        ...
        "Lose": Text("You lose !", (0, -100), 50, True, (42, 40, 57)),
    },
]
