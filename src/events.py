...
def events(player: Player | None = None) -> None:
    ...
    for evenement in pygame.event.get():
        ...
        if (
        ...
        ):  # L'evénement est un clic sur la souris
            ...
            if not game_data["pause"]:
                ...
                for (
                    ...
                    Sprite.Sprites_list
                ):  # Récupère tous les sprites qui sont en contact avec la souris
                ...
                game_data["clicked_button_menu"] = [
                    s for s in Texts_menu if s.rect.collidepoint(pos)
                ]  # Récupère tous les textes du menu qui sont en context avec la souris
